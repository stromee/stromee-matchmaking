...
import { Image, Paragraph, Spinner, Text, View, YStack } from 'tamagui';
...
const Address = ({
	...
	return (
		<YStack
		flex={1} px="$4" pb="$8" gap="$4" jc="space-between"
		>
			...
			<BodyText px="$3" textAlign="left">
				Nicht jeder ist ein Fan von Fernbezhieungen. Daher sag uns doch,
				in welcher Stadt du wohnst, damit wir den passenden Partner in
				deiner Nähe für dich finden!
			</BodyText>
